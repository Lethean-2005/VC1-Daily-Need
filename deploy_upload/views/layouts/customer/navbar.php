...
<style>
/* Navbar theme — full-width floating white pill navbar */
.dn-navbar {
    position: fixed;
    top: 16px;
    left: 50%;
    ...
    background: #fff;
    border-radius: 5px;
    box-shadow: 0 12px 28px rgba(15,85,83,.12);
    padding-top: .3rem;
    padding-bottom: .3rem;
    z-index: 1030;
}
.dn-navbar .container { max-width: 100%; padding-left: 12px; padding-right: 12px; }
.dn-navbar-brand {
    display: inline-flex;
    align-items: center;
    gap: 8px;
...
.dn-nav-cta i { color: #d98c4a; }
.dn-nav-cta:hover { background: #2b241d; color: #fff; transform: translateY(-1px); }
